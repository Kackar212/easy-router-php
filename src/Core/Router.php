...
use EasyRouter\Core\Routes\Route;
...
class Router
{
  ...
  function start()
  {
    ...
    $routesWithRequestMethod = $matchedRoutes->filter(function (Route $route) {
    ...
    $this->run($component, $matchedRoute);
  }

  private function run($component, Route $matchedRoute)
  {
    return DI::resolve($component, $matchedRoute->getParameters());
  }
